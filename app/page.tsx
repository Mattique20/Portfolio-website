...
export default function Page() {
  ...
  <RevealOnView
    as="div"
    intensity="hero"
    // 1. Added 'h-full' here so the card fills the sticky container
    // 2. Removed padding here (moved to inner scroll wrapper) so scrollbar is at the edge
    className="relative flex h-full flex-col overflow-hidden rounded-3xl border border-white/10 bg-neutral-900/60"
    staggerChildren
  >
    {/* Texture background (Stays behind scroll) */}
    <div className="pointer-events-none absolute inset-0 opacity-5 mix-blend-soft-light">
      <DotGridShader />
    </div>

    {/* Floating particles animation (Stays behind scroll) */}
    ...
    {/* === THE FIX === 
       Wrap ALL content in this div. 
       'h-full' + 'overflow-y-auto' creates the internal scrollbar 
       when the screen is too short or zoomed in.
    */}
    <div className="flex flex-col justify-between p-6 sm:p-8 h-full overflow-y-auto no-scrollbar">
      ...
      <div>
        ...
        <div className="mb-6 flex justify-center">
          <div className="relative w-24 h-24 rounded-full overflow-hidden border-2 border-white/20 hover:border-white/40 transition-all duration-300 hover:scale-105 group shrink-0">
            <img
        ...
        <p className="mt-4 max-w-[42ch] text-lg text-white/70">
          I love building new things and then breaking them to make them even better. Let's create something resilient together!
        </p>
        ...
        <div className="mt-6 flex flex-wrap items-center gap-3">
          ...
          >
            <a href="/Mohammad_Attique_CV.pdf" download>
      ...
      <div className="mt-10 pt-6">
        ...
        <ul className="grid grid-cols-1 sm:grid-cols-2 gap-x-8 gap-y-3 text-1xl font-semibold text-white/60 opacity-80">
          <li className="hover:text-white transition-colors cursor-default">QLU.ai</li>
